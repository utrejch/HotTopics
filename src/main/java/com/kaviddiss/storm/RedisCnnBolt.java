 ...
 */
public class RedisCnnBolt extends BaseRichBolt {
     ...
     * @param redisDb
     */
    public RedisCnnBolt(final String key, final String redisHost, final int redisPort, final int redisDb) {
        super();
        this.key = key;
    ...
    public void execute(final Tuple input) {
        ...
        redis.publish("Cnn", new StringBuilder().append(word).append("|")
